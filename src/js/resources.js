define([
    ...
    "../html/resources/template.hbs",
    "../nls/labels"
], function ($, log, _, C, RC, template, labels) {
    ...
    Resources.prototype._validateConfig = function () {
    ...
    Resources.prototype._initVariables = function () {
    ...
    Resources.prototype._importThirdPartyCss = function () {
