define([
    ...
    "../html/editPolicy/template.hbs",
    "../nls/labels"
], function ($, log, _, C, EPC, template, labels) {
    ...
    EditPolicy.prototype._validateConfig = function () {
    ...
    EditPolicy.prototype._initVariables = function () {
    ...
    EditPolicy.prototype._importThirdPartyCss = function () {
